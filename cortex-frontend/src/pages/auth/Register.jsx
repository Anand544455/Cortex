...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      await register(form);
      push('Account created. Your workspace is ready.');
      navigate('/');
    } catch (err) {
    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-card shadow-lift p-7">
          <h1 className="font-display font-semibold text-navy text-lg mb-1">Create your account</h1>
          <p className="text-sm text-slate mb-6">Sets up your first workspace automatically.</p>
